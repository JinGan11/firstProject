 ...
 * @date 2019/8/7 15:32
 **/
public class SupportBusinessUtil {
     ...
     */
    public static List<DepartmentUpperDto> setCanChooseBySupports(List<DepartmentUpperDto> list, Long choosedId) {
        // 获取选择的部门的业务线
        String supports = "";
        for (DepartmentUpperDto item : list) {
