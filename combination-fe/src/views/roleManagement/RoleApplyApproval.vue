    ...
    <el-table ref="multipleTable" :data="tableData" border>
      <el-table-column label="选择" width="45">
        <template slot-scope="scope">
          <el-radio v-model="selection" :label="scope.row.role_id" ><span width="0px;"></span></el-radio>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="approver_emp" label="审批负责人" width="120"></el-table-column>
      <el-table-column prop="business_line" label="角色支持业务线" width="120"></el-table-column>
      ...
      <el-table-column prop="apply_staff_name" label="申请人员工姓名" width="120"></el-table-column>
      <el-table-column prop="apply_department_name" label="申请人所属部门" width="120"></el-table-column>
      <el-table-column prop="apply_time" label="申请时间"width="150"></el-table-column>
      <el-table-column prop="status" label="状态" width="100"></el-table-column>
      <el-table-column prop="modify_emp" label="操作人" width="120"></el-table-column>
