  ...
  <home>
        ...
        <el-row>
          ...
          <el-col :span="10">
            <el-form-item label="申请角色">
              ...
              <el-button type="text" @click="selectRoleForRoleApply('selectRole')">选择</el-button>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
    ...
    <div style="margin-left: 40px;margin-bottom:20px;border-bottom:1px solid gray;padding-bottom: 20px">
      <el-row :gutter="20">
        ...
        <el-col :span="2">
          <el-button type="primary" size="mini" @click="addAccountForApply('selectAccount')">添加</el-button>
        </el-col>
      </el-row>
    </div>
    ...
    <el-dialog :title='title1' :visible.sync="dialogVisible" v-if="dialogCategory === 'selectRole'" :close-on-click-modal="false" width="80%">
      <div>
      ...
      <el-table :data="tableDataRole" border @row-click="getRoleDetails"  @selection-change="handleCurrentChange1" >
        <el-table-column label="选择" width="45">
          <template slot-scope="scope">
            <el-radio v-model="selection1" :label="scope.row.roleId"><span width="0px;"></span></el-radio>
          </template>
        </el-table-column>
        <el-table-column prop="id" v-if="false" label="隐藏id"></el-table-column>
    ...
    <el-dialog :title='title2' :visible.sync="dialogVisible" v-if="dialogCategory === 'selectAccount'" :close-on-click-modal="false" width="80%">
      <div style="width: 95%;">
      ...
      <el-table ref="multipleTable" :data="tableData" border  @selection-change="handleCurrentChange" :row-key="getRowKeys" >
...
<script>
  export default {
    ...
    methods:{
      ...
      //   this.selection = val;
      // },
      // val  handleSelectionChange(val) {
      //     this.multipleSelection = val;
      //   },



      // selectAccountInfo(val){
      //   this.multipleSelection=val;
      // },


      fetchDataRole() { //获取数据   角色管理列表
        var self = this;
        var param = {
      ...
      selectRoleForRoleApply(dialogCategory = ''){
        //点击选择，弹出选择角色对话框
      ...
      addAccountForApply(dialogCategory = ''){
        //点击添加按钮，进入账号选择页面
        this.dialogVisible=true;
        //加入弹窗标记
        this.dialogCategory = dialogCategory;
